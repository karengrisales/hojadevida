    ...
    <div>
      ...
      <div className='ml-10 text-justify mr-10 mb-5'>
        ...
        <p>
          ...
          perfiles necesarios para la compañía. Dominio de la herramienta
          HubSpot.
        </p>
        <br />
        <br />
        ...
        <p>
          ...
          de computadoras, asistencia remota de equipos laborales a diversos
          municipios del Cauca, monitoreo de redes LAN y WAN, soporte de
          Telefonía IP y aplicativos empresariales en Contact Center.
        </p>
        <br />
        <br />
